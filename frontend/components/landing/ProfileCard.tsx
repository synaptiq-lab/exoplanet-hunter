        ...
        <div className="pc-inside">
          ...
          <div className="pc-content pc-avatar-content">
            <img
              ...
              loading="lazy"
            style={{ bottom: `${avatarBottomOffset}px`, transform: `translateX(-50%) scale(${avatarScale})` }}
                ...
                <div className="pc-user-details">
                  <div className="pc-mini-avatar">
                    <img
                      ...
                      loading="lazy"
                      onError={(e: any) => { e.target.style.opacity = '0.5'; e.target.src = avatarUrl; }}
                    />
                  </div>
